...
export default function SearchSwitcher({
  ...
  return (
    <div ref={rootRef} className={`relative min-w-0 ${className}`}>
      ...
      {open && (
        <div className="absolute left-0 top-full z-50 mt-1.5 w-full min-w-[16rem] overflow-hidden rounded-lg border border-pine-200 bg-white shadow-lg sm:w-72">
          <div className="border-b border-pine-100 px-3 py-2">
            <p className="text-xs font-medium uppercase tracking-wide text-pine-500">Switch search</p>
          </div>
